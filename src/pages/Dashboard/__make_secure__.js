 ...
 * if not admin then redirect to any other page. you could logout user and send to the login page as well.
 * ---------------
 *      TO SEND DATA 
 * ----------------------
 * 1. verify jwt token (send authorization token in the header to the serve).
